...
enc_lat=30000 # encryption latency in nanoseconds
dec_lat=30000 # decryption latency in nanoseconds
enable_crypt_delay=1; # boolean for enabling encryption simulation
enable_tweakless=1; # boolean for enabling tweakless encryption
...
nchs=1 # number of channels
ssd_size=750 # in megabytes, if you change the above layout parameters, make sure you manually recalculate the ssd size and modify it here, please consider a default 25% overprovisioning ratio.

# Latency in nanoseconds
pg_rd_lat=400000 # page read latency
...
FEMU_OPTIONS=${FEMU_OPTIONS}",enc_lat=${enc_lat}"
FEMU_OPTIONS=${FEMU_OPTIONS}",dec_lat=${dec_lat}"
FEMU_OPTIONS=${FEMU_OPTIONS}",enable_crypt_delay=${enable_crypt_delay}"
FEMU_OPTIONS=${FEMU_OPTIONS}",enable_tweakless=${enable_tweakless}"
