...
static Property femu_props[] = {
    DEFINE_PROP_INT32("enc_lat", FemuCtrl, bb_params.enc_lat, 30000),
    DEFINE_PROP_INT32("dec_lat", FemuCtrl, bb_params.dec_lat, 30000),
    DEFINE_PROP_INT32("enable_crypt_delay", FemuCtrl, bb_params.enable_crypt_delay, 0),
    DEFINE_PROP_INT32("enable_tweakless", FemuCtrl, bb_params.enable_tweakless, 0),
